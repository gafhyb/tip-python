...
class TestTips(unittest.TestCase):
    ...
    def test_authiris_ok(self):
        self._common_ok('toto', 'Authiris toto', 'https://authiris.unistra.fr/authiris/bin/cptedit?uti=toto')

    def test_authiris_ko(self):
        self._common_ko('héhé', 'Authiris héhé')

    def test_wikitionnaire_ok(self):
        self._common_ok('héhé', 'Wikitionnaire héhé', 'https://fr.wiktionary.org/w/index.php?search=h%C3%A9h%C3%A9')

    def test_wikitionnaire_ko(self):
        self._common_ko('expression régulière', 'Wikitionnaire expression régulière')

    def test_wikipedia(self):
        self._common_ok('expression régulière', 'Wikipedia expression régulière',
                        'https://fr.wikipedia.org/w/index.php?title=expression+r%C3%A9guli%C3%A8re')

    def test_url(self):
        self._common_ok('toto<a href="https://www.unistra.fr">Unistra</a>tutu titi', 'Open https://www.unistra.fr',
                        'https://www.unistra.fr')

    def test_timestamp(self):
        self._common_ok('1587476268', 'Timestamp',
                        '21/04/2020 15:37:48')
